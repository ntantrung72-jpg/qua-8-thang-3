...
const floatMessages = [
    ...
    "Hoa này là hoa code ngửi thử đi xem có mùi cafe với nước tăng lực không",
...
function startFlowerAnimation() {
    ...
    giftInterval = setInterval(() => {
        ...
        textElement.innerText = floatMessages[Math.floor(Math.random() * floatMessages.length)];
